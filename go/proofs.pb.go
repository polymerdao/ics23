...
//
//Verkle proof is a multiproof of mixed existence and nonexistence.
...
func (m *VerkleProof) Reset()         { *m = VerkleProof{} }
func (m *VerkleProof) String() string { return proto.CompactTextString(m) }
func (*VerkleProof) ProtoMessage()    {}
func (*VerkleProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_855156e15e7b8e99, []int{2}
}
func (m *VerkleProof) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VerkleProof) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VerkleProof.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VerkleProof) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerkleProof.Merge(m, src)
}
func (m *VerkleProof) XXX_Size() int {
	return m.Size()
}
func (m *VerkleProof) XXX_DiscardUnknown() {
	xxx_messageInfo_VerkleProof.DiscardUnknown(m)
}

var xxx_messageInfo_VerkleProof proto.InternalMessageInfo

func (m *VerkleProof) GetKey() [][]byte {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *VerkleProof) GetValue() [][]byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *VerkleProof) GetProof() []byte {
	if m != nil {
		return m.Proof
	}
	return nil
...
type CommitmentProof_Verkle struct {
	Verkle *VerkleProof `protobuf:"bytes,5,opt,name=verkle,proto3,oneof" json:"verkle,omitempty"`
}
...
func (*CommitmentProof_Verkle) isCommitmentProof_Proof()     {}
...
func (m *CommitmentProof) GetVerkle() *VerkleProof {
	if x, ok := m.GetProof().(*CommitmentProof_Verkle); ok {
		return x.Verkle
	}
	return nil
}
...
func (*CompressedNonExistenceProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_855156e15e7b8e99, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*VerkleProof)(nil), "ics23.VerkleProof")
...
var fileDescriptor_855156e15e7b8e99 = []byte{
	...
	,
}
...
func (m *VerkleProof) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VerkleProof) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VerkleProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Proof) > 0 {
		i -= len(m.Proof)
		copy(dAtA[i:], m.Proof)
		i = encodeVarintProofs(dAtA, i, uint64(len(m.Proof)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Value) > 0 {
		for iNdEx := len(m.Value) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProofs(dAtA, i, uint64(len(m.Value[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.Key) > 0 {
		for iNdEx := len(m.Key) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProofs(dAtA, i, uint64(len(m.Key[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *CommitmentProof_Verkle) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommitmentProof_Verkle) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Verkle != nil {
		{
...
func (m *CompressedExistenceProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Path) > 0 {
		dAtA18 := make([]byte, len(m.Path)*10)
		var j17 int
		...
		i = encodeVarintProofs(dAtA, i, uint64(j17))
		i--
		dAtA[i] = 0x22
	}
	if m.Leaf != nil {
...
func (m *CommitmentProof_Verkle) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VerkleProof) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VerkleProof: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VerkleProof: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CommitmentProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Proof = &CommitmentProof_Verkle{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProofs(dAtA[iNdEx:])
